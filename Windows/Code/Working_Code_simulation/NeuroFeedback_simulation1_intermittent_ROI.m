...
sca;
clear all
global TR window scr_rect centreX centreY escapeKey start_time current_TBV_tr ROI_mean_PSC ROI_vals PSC_thresh port_issue;


%% Can be modified

TR = 1.0; %Interval between consecutive fMRI volumes
