...
sca;
clear all
global TR window scr_rect centreX centreY escapeKey start_time current_TBV_tr ROI_PSC ROI_vals PSC_thresh port_issue texture;
...
feedback_dir = [pwd '/Data/NeuroFeedback_RunSeven'];
feedback_file_name = 'NeuroFeedback_RunSeven';
run_no = 7;
...
%Screen('DrawTexture',window,texture,[],[],[],[],[],[feedback_num,10,10]);
Screen('Flip',window);
...
%curr_feedback = round((current_psc/PSC_thresh)*255,1); %only deactivation (for changing redness of image)
